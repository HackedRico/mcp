...
cal_serv = CalderaService(BaseService)
...
@mcp.tool()
async def get_abilities_by_tactic(tactic: str):
    """
...
@mcp.tool()
async def get_ability_by_id(ability_id: str):
    """
...
async def get_adversary_by_id(adversary_id: str):
    data_svc = cal_serv.data_svc
...
@mcp.tool()
async def get_adversary_by_name(name: str):
    """
...
@mcp.tool()
async def get_adversary_id(id: str):
    """
...
@mcp.tool()
async def get_agent_by_paw(paw: str):
    """
...
@mcp.tool()
async def get_operation_by_id(operation_id: str):
    """
...
@mcp.tool()
async def get_operation_links(operation_id: str):
    """
...
@mcp.tool()
async def get_operation_link(operation_id: str, link_id: str):
    """
...
@mcp.tool()
async def get_operation_link_result(operation_id: str, link_id: str):
    """
...
async def create_adversary(
    name: str, description: str, atomic_ordering: list
):
    """
...
@mcp.tool()
async def create_operation(operation_name: str, adversary_name: str):
    """
